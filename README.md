...
├── dags/
│   └── student_analytics_dag.py  # Airflow DAG for analytics
├── scripts/
...
Connect Grafana to your PostgreSQL database to create custom dashboards:
...
The included Airflow DAG (`student_analytics_dag.py`) runs daily to:
